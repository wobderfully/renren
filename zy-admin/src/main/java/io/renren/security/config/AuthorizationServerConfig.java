...
import io.renren.security.constant.OauthConstant;
import io.renren.security.exception.RenWebResponseExceptionTranslator;
import io.renren.security.token.RenTokenEnhancer;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        //登录或者鉴权失败时的返回信息
        endpoints.exceptionTranslator(new RenWebResponseExceptionTranslator());
